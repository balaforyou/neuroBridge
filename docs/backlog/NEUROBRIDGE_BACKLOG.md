...
### PM-001.04.2 Peek and Submission Review Composition
...
### PM-001.04.3 Analytics Evidence Directionality

Status: Backlog

Goal:
Strengthen analytics test expectations so scaffolded evidence never outweighs independent evidence for the same level and result.
...
### PM-001.04.4 Scaffold Support Strength Ordering
...
Do not finalize weighting formulas yet.

This is a future analytics/scaffold refinement.

### PM-001.04.5 Public Documentation Privacy Review
...
No change required now unless public repository exposure is planned.

### PM-001.04.6 Level ID Alias Clarification

Status: Backlog

Goal:
Clarify relationship between short learner/design level IDs and long metadata IDs.
